  ...
  return (
    <div style={{ background: 'linear-gradient(180deg, #000 0%, #1e3a8a 100%)', minHeight: '100vh', color: '#fff', fontFamily: 'Cinzel, Georgia, serif' }}>
      <header style={{ background: 'rgba(0,0,0,0.9)', borderBottom: '2px solid #1e3a8a', padding: '15px 20px', position: 'sticky', top: 0, zIndex: 100, display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        <h1 style={{ fontSize: '18px', letterSpacing: '2px', color: '#60a5fa', textShadow: '0 0 10px rgba(96,165,250,0.5)' }}>⚔ RANKING VALHALLA ⚔</h1>
        <div style={{ display: 'flex', alignItems: 'center', gap: '15px' }}>
          {user ? (
            <>
              <span style={{ color: '#60a5fa', fontSize: '14px' }}>{user.email}</span>
              <a href="/tree" style={{ padding: '8px 16px', background: 'rgba(30,58,138,0.3)', border: '1px solid #2563eb', color: '#60a5fa', textDecoration: 'none', borderRadius: '8px', fontSize: '14px' }}>Árvore</a>
              {user.isAdmin && <a href="/admin" style={{ padding: '8px 16px', background: 'rgba(30,58,138,0.3)', border: '1px solid #2563eb', color: '#60a5fa', textDecoration: 'none', borderRadius: '8px', fontSize: '14px' }}>Admin</a>}
              <button onClick={() => {
            ...
            <a href="http://localhost:3001/auth/google" style={{ padding: '8px 16px', background: '#fff', color: '#1e3a8a', textDecoration: 'none', borderRadius: '8px', fontSize: '14px', fontWeight: 'bold', display: 'flex', alignItems: 'center', gap: '8px' }}>
      ...
      <div style={{ padding: '40px 20px', maxWidth: '800px', margin: '0 auto' }}>
        <h2 style={{ textAlign: 'center', color: '#60a5fa', fontSize: '32px', marginBottom: '40px', textShadow: '0 0 20px rgba(96,165,250,0.7)' }}>🏆 RANKING DE GUERREIROS 🏆</h2>
