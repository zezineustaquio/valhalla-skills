        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '15px' }}>
          {user ? (
            <>
              ...
              <a href="/" style={{ padding: '8px 16px', background: 'rgba(30,58,138,0.3)', border: '1px solid #2563eb', color: '#60a5fa', textDecoration: 'none', borderRadius: '8px', fontSize: '14px' }}>🏆 Ranking</a>
